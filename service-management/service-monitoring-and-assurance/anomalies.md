...
By clicking the arrow icon in the  the widget <img src="../../.gitbook/assets/image (5).png" alt="" data-size="line">, you can access to the page with the entire list of Anomalies.&#x20;
